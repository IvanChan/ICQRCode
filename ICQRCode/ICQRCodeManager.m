...
#import <ICUIKit/ICQRCodeController.h>
#import <ICUIKit/ICColorButton.h>
...
- (void)prepareExtraControls:(UIView *)parentView
{
    if (_extraControlsView == nil)
    {
        ...
        ICColorButton * galleryButton = [[ICColorButton alloc] initWithFrame:CGRectMake(gapBetweenButtons,
        ...
        [galleryButton setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.6]
                                      forState:UIControlStateNormal];
        [galleryButton setBackgroundColor:[[UIColor grayColor] colorWithAlphaComponent:0.3]
                                      forState:UIControlStateNormal];
        ...
        ICColorButton *flashLightButton = [[ICColorButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(galleryButton.frame) + gapBetweenButtons,
                                                                                CGRectGetMinY(galleryButton.frame),
                                                                                buttonWidth,
                                                                                buttonWidth)];
        [flashLightButton setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.8]
                                         forState:UIControlStateNormal];
        [flashLightButton setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.6]
                                         forState:UIControlStateNormal];
        [flashLightButton setBackgroundColor:[[UIColor grayColor] colorWithAlphaComponent:0.3]
                                         forState:UIControlStateNormal];
        ...
        ICColorButton *closeButton = [[ICColorButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(flashLightButton.frame) + gapBetweenButtons,
                                                                           CGRectGetMinY(galleryButton.frame),
                                                                           buttonWidth,
                                                                           buttonWidth)];
        ...
        [closeButton setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.6]
                                    forState:UIControlStateNormal];
        [closeButton setBackgroundColor:[[UIColor grayColor] colorWithAlphaComponent:0.3]
                                    forState:UIControlStateNormal];
